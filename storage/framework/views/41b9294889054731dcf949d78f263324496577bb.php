...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><?php echo e(__('Личный кабинет')); ?></div>
                <div class="card-header"><?php echo e(__('Регистрация')); ?></div>

                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('changeProfil')); ?>">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="email" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Электронная почта')); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="row mb-3">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-end"><?php echo e(__('Повтор пароля')); ?></label>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-primary">
                                    <?php echo e(__('Применить изменения')); ?>
                    ...
                    <div class="card-header"><?php echo e(__('Список заказов')); ?></div>
                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="card" style="width: 18rem;">
                        <div class="card-body">
                            ...
                            <p class="card-text"><?php echo e($order->weight); ?>  <?php echo e($order->time); ?> </p>
                            <a href="<?php echo e(route('personalDelete', ['id' =>$order->id_order])); ?>" class="btn btn-primary">Удалить заказ</a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\localhost\resources\views/personal.blade.php ENDPATH**/ ?>